...
<h2 style='text-align:center'>YOUR CURRENT TASK </h2>
<table class="project-list">
<tr> <th scope="col">Project Name</th> <th scope="col">Task Name</th> <th scope="col">Start Date</th> <th scope="col">Due Date</th> <th scope="col">Priority</th> <th scope="col">Done</th> <th scope="col">Delete</th><th scope="col"> Edit </th><th scope="col"> Show Notes </th> </tr>
	<?php
		...
		while($row = $result ->fetch_assoc())
		{
			...
			<td ;><a text-decoration: 'none' class='edit' href='Task.php?done=1&taskID=",$row["taskID"],"'>&#10004</a></td>
			<td><a class= 'edit' href='Task.php?delete=1&taskID=",$row["taskID"],"'>&#10060</a></td>
			<td><a class='btn' href='EditTask.php?edit=1&taskID=",$row["taskID"],"'>Edit</a></td>
			<td style='text-align:center'> <button id='notesButton-",$row['taskID'],"' onClick =\"showNotes('",$row['taskID'],"')\"'>Show Notes </button> </td>
			</tr>
			<tr class='notes'>
...
<form action="newTask.php" method="POST" style='text-align:center'>
	...
	<select required name="ProjectId"> 
		...
		<br>
		<textarea type="text" rows='10' cols='80' name = "taskNotes" placeholder="Notes Here" style='margin-top:30px'></textarea>
		<br>
		<div class="login-box">
		<input type="submit" name="newTask" class="btn">
		</div>
